...
import com.aisparser.util.NavigationalStatus;
...
public class Message01 extends Message {
	...
	private int            smi;               // 2 bits  : special manoeuvre indicator 
	...
	public String getNavStatusDescription() {return NavigationalStatus.getDescription(this.nav_status);}
		...
		throws SixbitsExhaustedException, AISMessageException
	{
		...
		this.sub_message  = (int)  six_state.getInt(14); //TODO: decode sub_message
	}
